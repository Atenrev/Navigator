...
class TestCases(unittest.TestCase):
    ...
    def test_Expand(self):
        ...
        self.assertEqual(expanded_paths, [Path(
            [13, 12, 8]), Path([13, 12, 11]), Path([13, 12, 13])])
    ...
    def test_Astar(self):
        ...
        # route = Astar(9, 3, self.map, 0)
        # self.assertEqual(route, Path([9, 8, 7, 6, 5, 2, 3]))

        # route = Astar(9, 3, self.map, 1)
        # self.assertEqual(route, Path([9, 8, 12, 11, 10, 2, 3]))

        # route = Astar(9, 3, self.map, 2)
        # self.assertEqual(route, Path([9, 8, 12, 11, 10, 2, 3]))

        # route = Astar(9, 3, self.map, 3)
        # self.assertEqual(route, Path([9, 8, 7, 6, 5, 2, 3]))
